...
import edu.mit.scansite.shared.event.DatabaseScanEventHandler;
import edu.mit.scansite.shared.event.EventBus;
import edu.mit.scansite.shared.event.LoginEvent;
import edu.mit.scansite.shared.event.LoginEventHandler;
import edu.mit.scansite.shared.event.LogoutEvent;
import edu.mit.scansite.shared.event.LogoutEventHandler;
...
import edu.mit.scansite.shared.event.OrthologScanMotifEvent;
import edu.mit.scansite.shared.event.OrthologScanMotifEventHandler;
import edu.mit.scansite.shared.event.OrthologScanSequencePatternEvent;
import edu.mit.scansite.shared.event.OrthologScanSequencePatternEventHandler;
import edu.mit.scansite.shared.event.PredictLocalizationEvent;
import edu.mit.scansite.shared.event.PredictLocalizationEventHandler;
import edu.mit.scansite.shared.event.ProteinScanEvent;
import edu.mit.scansite.shared.event.ProteinScanEventHandler;
import edu.mit.scansite.shared.event.SequenceMatchEvent;
import edu.mit.scansite.shared.event.SequenceMatchEventHandler;
