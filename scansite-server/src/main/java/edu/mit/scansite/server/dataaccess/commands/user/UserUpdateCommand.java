...
public class UserUpdateCommand extends DbUpdateCommand {
	...
	public UserUpdateCommand(Properties dbAccessConfig, Properties dbConstantsConfig, User user,
	...
	protected String doGetSqlStatement() throws DataAccessException {
		...
		sql.append(c.UPDATE).append(c.gettUsers()).append(c.SET).append(c.getcUsersFirstName()).append(c.EQ)
				.append(c.enquote(user.getFirstName())).append(c.COMMA).append(c.getcUsersLastName()).append(c.EQ)
