...
public class ProteinIdentifierResource {
                                                      ...
                                                      @QueryParam("searchPattern") String searchPattern)
    {
        ...
        if (!StringUtils.isBlank(dataSourceName) && !StringUtils.isBlank(searchPattern)) {
            ...
            GetDataSourcesStatement dsStmt = new GetDataSourcesStatement(false, false,
                    false, true, true, false,
                    false, false, false, null, dataSourceTypeId,
...
//            SELECT, PROTEIN_IDENTIFIER, FROM, talbeNamePlaceHolder, WHERE, PROTEIN_IDENTIFIER, LIKE ...
            final String partialIdentifier = "%" + searchPattern + "%";
            GetProteinsStatement statement = new GetProteinsStatement(dataSourceName, LIKE, true,
                    false, false, false, false,
                    false, false, false, false,
                    partialIdentifier, null, null, null, null,
                    null, null, null, null);
