...
public class LocalizationTypeAddCommand extends DbInsertCommand {
	...
	public LocalizationTypeAddCommand(Properties dbAccessConfig, Properties dbConstantsConfig,
			DataSource localizationTypeDataSource, LocalizationType localizationType) {
	...
	protected String doGetSqlStatement() throws DataAccessException {
		...
		sql.append(CommandConstants.INSERTINTO).append(c.gettLocalizationTypes()).append('(')
				.append(c.getcLocalizationTypesName()).append(CommandConstants.COMMA).append(c.getcDataSourcesId())
				.append(')').append(CommandConstants.VALUES).append('(')
				.append(CommandConstants.enquote(localizationType.getName())).append(CommandConstants.COMMA)
