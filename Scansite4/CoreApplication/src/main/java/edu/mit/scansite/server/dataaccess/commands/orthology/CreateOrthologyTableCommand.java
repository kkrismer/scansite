...
public class CreateOrthologyTableCommand extends DbUpdateCommand {
	...
	public CreateOrthologyTableCommand(Properties dbAccessConfig, Properties dbConstantsConfig, DataSource dataSource) {
	...
	protected String doGetSqlStatement() throws DataAccessException {
		String sql = "CREATE TABLE IF NOT EXISTS " + c.gettOrthology(dataSource) + " (\n" + c.getcOrthologsId()
				+ " INT(11) NOT NULL AUTO_INCREMENT,\n" + " " + c.getcOrthologsGroupId() + " INT(11) NOT NULL,\n"
				+ c.getcOrthologsIdentifier() + "           VARCHAR(30) NOT NULL,\n" + " PRIMARY KEY ("
