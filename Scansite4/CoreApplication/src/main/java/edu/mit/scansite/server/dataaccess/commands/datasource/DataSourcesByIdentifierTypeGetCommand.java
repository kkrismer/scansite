 ...
 */
public class DataSourcesByIdentifierTypeGetCommand extends DbQueryCommand<List<DataSource>> {
	private IdentifierType type;

	public DataSourcesByIdentifierTypeGetCommand(Properties dbAccessConfig, Properties dbConstantsConfig,
			IdentifierType type) {
