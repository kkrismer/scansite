...
public class CreateAnnotationsTableCommand extends DbUpdateCommand {
	...
	public CreateAnnotationsTableCommand(Properties dbAccessConfig, Properties dbConstantsConfig,
	...
	protected String doGetSqlStatement() throws DataAccessException {
		String sql = "CREATE TABLE IF NOT EXISTS " + c.gettAnnotations(dataSource) + " (\n" + "  "
				...
				+ ") REFERENCES " + c.getProteins(dataSource) + "(" + c.getcProteinsIdentifier() + "),\n"
				+ "  FOREIGN KEY (" + c.getcAnnotationTypesId() + ") REFERENCES " + c.gettAnnotationTypes() + "("
				+ c.getcAnnotationTypesId() + "),\n" + "  PRIMARY KEY(" + c.getcAnnotationsId() + ", "
