...
public class PredictLocalizationMotifProteinPairHandler
		implements ActionHandler<PredictLocalizationMotifProteinPairAction, PredictLocalizationResult> {
	...
	@Override
	public PredictLocalizationResult execute(PredictLocalizationMotifProteinPairAction action, ExecutionContext context)
		...
		try {
			...
			PredictProteinsLocalizationResult proteinLocalization = (PredictProteinsLocalizationResult) feature
					.doPredictProteinLocalization(action.getLocalizationDataSource(), action.getProtein());
			if (proteinLocalization.isSuccess()) {
				result.setTotalProteinLocalizations(proteinLocalization.getTotalProteinLocalizations());
				result.setProteinLocalization(proteinLocalization.getLocalization());
			}

			try {
				Localization motifLocalization = feature.doPredictMotifLocalization(action.getLocalizationDataSource(),
						action.getMotif());
	...
	@Override
	public void rollback(PredictLocalizationMotifProteinPairAction action, PredictLocalizationResult result,
