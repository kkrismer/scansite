...
public class NewsGetAllCommand extends DbQueryCommand<List<NewsEntry>> {
	...
	public NewsGetAllCommand(Properties dbAccessConfig, Properties dbConstantsConfig, int nrOfNewestEntries) {
		super(dbAccessConfig, dbConstantsConfig);
		this.count = nrOfNewestEntries;
	}

	@Override
	protected List<NewsEntry> doProcessResults(ResultSet result) throws DataAccessException {
