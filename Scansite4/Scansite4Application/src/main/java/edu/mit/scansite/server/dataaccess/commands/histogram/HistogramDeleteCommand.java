...
public class HistogramDeleteCommand extends DbUpdateCommand {
	...
	public HistogramDeleteCommand(Properties dbAccessConfig, Properties dbConstantsConfig, int motifId,
	...
	protected String doGetSqlStatement() throws DataAccessException {
		...
		sql.append(CommandConstants.DELETEFROM).append(c.gettHistograms()).append(CommandConstants.WHERE)
