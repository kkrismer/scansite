...
public class MockDomainLocator extends DomainLocator {
	...
	public ArrayList<DomainPosition> getDomainPositions(String realPath, String sequence) {
		...
		positions.add(new DomainPosition(19, 104, "CAMSAP_CH", "PFAM",
				"PF00621"));
		positions
				.add(new DomainPosition(199, 373, "RhoGEF", "PFAM", "PF00130"));
		positions.add(new DomainPosition(404, 505, "PH", "PFAM", "PF00017"));
		positions.add(new DomainPosition(517, 569, "C1_1", "PFAM", "PF00621"));
		positions.add(new DomainPosition(616, 653, "SH3_1", "PFAM", "PF07653"));
		positions.add(new DomainPosition(672, 746, "SH2", "PFAM", "PF00169"));
		positions.add(new DomainPosition(789, 835, "SH3_1", "PFAM", "PF00130"));
