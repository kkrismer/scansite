 ...
 */
public class MotifNumbersRetrieverHandler implements
		ActionHandler<MotifNumbersRetrieverAction, MotifNumbersRetrieverResult> {
	private final Logger logger = LoggerFactory.getLogger(this.getClass());
	private final Provider<ServletContext> contextProvider;
	private final LoginHandler loginHandler;

	@Inject
	public MotifNumbersRetrieverHandler(
	...
	@Override
	public MotifNumbersRetrieverResult execute(
			MotifNumbersRetrieverAction action, ExecutionContext context)
	...
	@Override
	public void rollback(MotifNumbersRetrieverAction arg0,
			MotifNumbersRetrieverResult arg1, ExecutionContext arg2)
			throws DispatchException {
	}
}