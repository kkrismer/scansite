 ...
 */
public class HistogramRetrieverHandler implements
		ActionHandler<HistogramRetrieverAction, HistogramRetrieverResult> {
	private final Logger logger = LoggerFactory.getLogger(this.getClass());
	private final Provider<ServletContext> contextProvider;

	@Inject
	public HistogramRetrieverHandler(
	...
	@Override
	public HistogramRetrieverResult execute(HistogramRetrieverAction action,
		...
		try {
			...
			if (sHist != null) {
				...
				imageIO.saveImage(
						sHist.getReferenceHistogramPlot(action.getSite()),
						filePath);
	...
	@Override
	public void rollback(HistogramRetrieverAction action,
