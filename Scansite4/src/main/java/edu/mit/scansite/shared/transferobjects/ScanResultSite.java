...
public class ScanResultSite implements IsSerializable {
	 ...
	 * 
	 * @param po
	 *            The position of the site (0 <= position < sequenceLength)
	 */
	...
	public String getSiteSequence() {
		...
		String hitChar = String.valueOf(seq.charAt(halfWindow)).toLowerCase();
		return seq.substring(0, halfWindow) + hitChar
				+ seq.substring(halfWindow + 1);
	}
